...
export default function Hero() {
  return (
    <div className='min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-[800px] w-full mx-auto'>
        ...
        <p className='text-sm md:text-base font-light'>I herby acknowlegment that i may become <span className='text-blue-400 font-medium'>unbelivably swolenormous</span> and accept all tisks of becoming the local <span className='text-blue-400 font-medium'>mass montrosity</span>, afflicted with severe body dismorphia, unable to fit through doors.</p>
